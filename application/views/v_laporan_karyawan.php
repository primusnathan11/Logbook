...
<div class="panel">
        ...
        <h2 class="display-4">Laporan Anda </h2>
		 <br>
		 <hr class="style1">
		 <br>
		</div>
        ...
        <?php $no=1; ?>
				...
				<tr>
					...
					<td>
					<?php if($dt_kom->status =="Selesai Dikerjakan"){?>
						<a href="<?php echo base_url().'index.php/Komplain/konfirmasi_selesai/'.$dt_kom->id_activity?>" class="btn btn-primary" onclick="return confirm('Pastikan sudah tidak ada masalah pada barang anda');">Konfirmasi</a>
					<?php } ?>
					</td>
